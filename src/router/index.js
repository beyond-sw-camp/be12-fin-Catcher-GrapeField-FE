...
const routes = [
    ...
    {path: "/search", name: 'Search', component: GeneralResult, props: route => ({ keyword: route.query.keyword })},
    {path: "/search/events", name: 'EventsResult', component: EventsResult, props: route => ({ keyword: route.query.keyword })},
    {path: "/search/post", name: 'PostResult', component: PostResult, props: route => ({ keyword: route.query.keyword })},
    {path: "/search/review", name: 'ReviewResult', component: ReviewResult, props: route => ({ keyword: route.query.keyword })},
